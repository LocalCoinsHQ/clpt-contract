...
// File: contracts\CLPTImplementation.sol
...
/**
 * @title CLPTImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing CLPTImplementation
...
contract CLPTImplementation {
    ...
    string public constant name = "Chilean Peso Token"; // solium-disable-line
    string public constant symbol = "CLPT"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all CLPT at the contract address.
     * This sends the CLPT tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimCLPT() external onlyOwner {
